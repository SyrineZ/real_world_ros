...
def box_height_info_callback(data):
    try:
        ...
        rospy.loginfo("the box height is %4.2f feet:"%(service_response.distance_feet))
...
if __name__ == '__main__':
    ...
    rospy.loginfo("Waiting for conversion...")
    rospy.wait_for_service('metres_to_feet')
    rospy.loginfo("Service %s is now available", 'Convert metres to feet')
