...
if __name__ == '__main__':
    ...
    sensor_topic = 'sensor_info'
    rospy.loginfo('Waiting for topic %s to be published...', sensor_topic)
    rospy.wait_for_message('/sensor_info', SensorInformation)
    rospy.loginfo('%s topic is now available!', sensor_topic)
